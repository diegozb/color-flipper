...
const colorAleatorio = Math.floor(Math.random()*colors.length)
  button.addEventListener('click', () => {
    fondo.style.background = colors[Math.floor(Math.random()*colors.length)]
    rgbcolor.innerText = fondo.style.background
  })
